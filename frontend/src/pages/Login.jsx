...
import cadastro from './img/LOGO.png';
...
function Login() {
  ...
  return (
    ...
    <div className="w-screen h-screen grid grid-cols-1 md:grid-cols-2 grid-rows-12">
      ...
      <a className="bg-white cursor-pointer w-72 h-10 flex justify-center items-center rounded-3xl font-bold text-xs hover:bg-gray-400" href="./cadastro.html">NÃO SOU CADASTRADO</a>
      </div>
    </div>
    </div>
  );
